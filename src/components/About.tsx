...
export const About = () => {
  return (
    <div className=" min-h-screen flex flex-col items-center">
      ...
      <div className="justify-center flex-auto flex flex-col mb-10 bg-gray-100  py-5 px-2 mx-3 rounded-lg max-w-lg md:max-w-2xl border-2 border-red-500 shadow-md">
